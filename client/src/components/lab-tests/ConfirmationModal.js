...
export default function ConfirmationModal({ bookingDetails, onClose }) {
  ...
  const { test, patientName, patientEmail, patientPhone, appointmentDate, appointmentTime, location } = bookingDetails;
        ...
        <div className="p-6">
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="grid grid-cols-3 gap-2 text-sm">
              ...
              <span className="col-span-2">{patientName}</span>
              
              <span className="text-gray-500">Date:</span>
              <span className="col-span-2">{appointmentDate}</span>
              
              <span className="text-gray-500">Time:</span>
              <span className="col-span-2">{appointmentTime}</span>
