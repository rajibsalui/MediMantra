            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="mt-10 pt-6 border-t border-gray-200">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="terms-checkbox" className="ml-3 text-gray-700">
      ...
      <div className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link href="/privacy" className="bg-blue-50 hover:bg-blue-100 rounded-xl p-6 text-center transition duration-300">
            ...
            <Link href="/help" className="bg-blue-50 hover:bg-blue-100 rounded-xl p-6 text-center transition duration-300">
            ...
            <Link href="/contact" className="bg-blue-50 hover:bg-blue-100 rounded-xl p-6 text-center transition duration-300">
              <h3 className="text-lg font-bold text-gray-900 mb-2">Contact Us</h3>
              <p className="text-gray-600">Reach out to our team for any questions or concerns.</p>
            </Link>
          </div>
        </div>
      </div>
